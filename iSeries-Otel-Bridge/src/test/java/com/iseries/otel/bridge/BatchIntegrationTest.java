...
class BatchIntegrationTest {
    ...
    void testJobExecution() throws Exception {
        ...
        JobParameters params = new JobParametersBuilder()
                ...
                .addLong("timestamp", System.currentTimeMillis()) // Unique param to force run
                .toJobParameters();
        ...
        boolean foundMultiline = EXPORTED_LOGS.stream()
                .anyMatch(log -> log.getBody().asString().contains("\n") || log.getBody().asString().contains("\r"));
